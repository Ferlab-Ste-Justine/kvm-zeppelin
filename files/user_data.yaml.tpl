...
%{ endif ~}
  ...
  - path: /opt/spark-defaults.conf
    ...
    content: |
      ...
      spark.jars.packages                           org.apache.hadoop:hadoop-aws:3.3.1,com.amazonaws:aws-java-sdk-bundle:1.11.901,io.delta:delta-core_2.12:1.0.0,io.projectglow:glow-spark3_2.12:1.0.1,bio.ferlab:datalake-spark31_2.12:0.2.43
